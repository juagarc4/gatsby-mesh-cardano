...
import {
  CardanoWallet, MeshBadge, useWallet } from '@meshsdk/react'
        ...
        <main className='main'>
          ...
          <div className='grid'>
            <a href='https://meshjs.dev/apis' className='card'>
              <h2>Documentation</h2>
              <p>
                Our documentation provide live demos and code samples; great educational tool for learning how Cardano
                works.
              </p>
            </a>

            <a href='https://meshjs.dev/guides/prove-wallet-ownership' className='card'>
              <h2>Prove ownership guide</h2>
              <p>
                Learn more about cryptographically prove the ownership of a wallet by signing a piece of data using data
                sign.
              </p>
            </a>
            ...
            <a href='https://meshjs.dev/react' className='card'>
              ...
              <p>
                Useful React UI components and hooks, seamlessly integrate them into your app, and bring the user
                interface to life.
              </p>
            </a>
          </div>
